...
export const metadata: Metadata = {
  title: "Privacy Policy | Prompt Later",
};
  ...
  return (
    <main className="mx-auto max-w-2xl px-6 py-16 font-['ABC_Diatype',system-ui,sans-serif] text-sm/6 text-neutral-800 dark:text-neutral-200">
      ...
      <div className="space-y-6 [&_h2]:mt-10 [&_h2]:mb-3 [&_h2]:text-lg [&_h2]:font-semibold [&_h2]:text-neutral-950 [&_h2]:dark:text-white [&_h3]:mt-4 [&_h3]:mb-1 [&_h3]:font-semibold [&_h3]:text-neutral-950 [&_h3]:dark:text-white [&_p]:text-neutral-600 [&_p]:dark:text-neutral-400 [&_ul]:list-disc [&_ul]:pl-5 [&_ul]:text-neutral-600 [&_ul]:dark:text-neutral-400 [&_li]:mb-2">
        <p>
          Prompt Later (&ldquo;Prompt Later&rdquo;, &ldquo;we&rdquo; or
          ...
          processes personal data when using Prompt Later&apos;s software, platform, APIs,
        ...
        <p>
          This Privacy Policy does not apply when Prompt Later acts as a data processor handling
        ...
        <ul>
          ...
          <li>
            <strong>Payment Information:</strong> Collected when accessing paid Prompt Later products and
            services
          </li>
          <li>
        ...
        <p>
          Prompt Later does not knowingly collect sensitive or special category personal
          ...
          under 18. Upon discovering or suspecting a user under 18, Prompt Later investigates
        ...
        <ul>
          ...
          <li>
            ...
            or Prompt Later legal liability protection
          </li>
          <li>
        ...
        <h2>4. Retention</h2>
        <p>
          Prompt Later retains personal data only as long as necessary for effective Service
        ...
        <p>
          When personal data is no longer needed, Prompt Later and service providers follow
        ...
        <p>
          ...
          exercise caution when deciding what information to share. Prompt Later is not
        ...
        <p>
          To exercise these rights, contact https://github.com/brahimhamichan/prompt-later/issues. Prompt Later may request
        ...
        <ul>
          ...
          <li>
            <strong>No automated decisions:</strong> Prompt Later does not make solely automated
        ...
        <p>
          Prompt Later processes personal data for described purposes on servers in various
        ...
        <p>
          Prompt Later may update this Privacy Policy periodically. Updated versions with
        ...
        <p>Contact https://github.com/brahimhamichan/prompt-later/issues with Privacy Policy questions.</p>
