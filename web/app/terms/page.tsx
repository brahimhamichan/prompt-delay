...
export const metadata: Metadata = {
  title: "Terms of Service | Prompt Later",
};
  ...
  return (
    <main className="mx-auto max-w-2xl px-6 py-16 font-['ABC_Diatype',system-ui,sans-serif] text-sm/6 text-neutral-800 dark:text-neutral-200">
      ...
      <div className="space-y-6 [&_h2]:mt-10 [&_h2]:mb-3 [&_h2]:text-lg [&_h2]:font-semibold [&_h2]:text-neutral-950 [&_h2]:dark:text-white [&_h3]:mt-4 [&_h3]:mb-1 [&_h3]:font-semibold [&_h3]:text-neutral-950 [&_h3]:dark:text-white [&_p]:text-neutral-600 [&_p]:dark:text-neutral-400">
        <p>
          Welcome, and thank you for your interest in Prompt Later (&ldquo;Prompt Later
          Software,&rdquo; &ldquo;we,&rdquo; or &ldquo;us&rdquo;), makers of the Prompt Later software
          platform. These Terms of Service (&ldquo;Terms&rdquo;) govern your access to and use of
          Prompt Later&apos;s software, platform, APIs, Documentation, and related tools,
          including the website, and all related software made available by Prompt Later to
        ...
        <p>
          ...
          Master Services Agreement (&ldquo;MSA&rdquo;) with Prompt Later, your use of the
        ...
        <p>If you have any questions or feedback, please email us at https://github.com/brahimhamichan/prompt-later/issues.</p>

        <h2>1. Access and Use</h2>

        <h3>1.1. Provision of Access.</h3>
        <p>
          Prompt Later is an applied research company working on automating coding. The Service
          ...
          Subject to your compliance with these Terms, Prompt Later grants you a limited right
        ...
        <p className="!uppercase !font-semibold">
          Prompt Later will not use Content to train, or allow any third party to train, any AI
        ...
        <p>
          ...
          or regulations; (x) send or otherwise provide to Prompt Later data or information that
          ...
          Prompt Later of any unauthorized use that comes to your attention and provide
        ...
        <p>
          From time to time, Prompt Later may make Beta Services available to you. Beta Services
          ...
          Prompt Later may discontinue Beta Services at any time in its sole discretion and may
          never make them generally available.
        </p>
        <p className="!uppercase !font-semibold">
          Prompt Later shall have no liability whatsoever arising out of or in connection with
        ...
        <p>
          ...
          notify us at https://github.com/brahimhamichan/prompt-later/issues.
        </p>
        ...
        <h3>4.2. Pricing.</h3>
        <p>
          Prompt Later reserves the right to determine pricing for the Service. Prompt Later
          will make reasonable efforts to keep pricing information published on the Service up to
          date. Prompt Later may change the fees for any feature of the Service, including
          additional fees or charges, if Prompt Later gives you advance notice of changes before
        ...
        <h3>5.1. Service.</h3>
        <p>
          Prompt Later and its licensors shall own and retain all right, title and interest in
        ...
        <p>
          ...
          (&ldquo;Feedback&rdquo;), then you grant Prompt Later the right to exploit the
          Feedback without restriction or compensation to you.
        </p>

        <h3>5.3. Content.</h3>
        <p>
          You retain all of your right, title, and interest that you have in Inputs, and Prompt Later
        ...
        <p>
          ...
          Services&rdquo;). Prompt Later will clearly indicate such content or features as
        ...
        <p>
          Prompt Later may modify or discontinue all or any portion of the Service at any time
          (including by limiting or discontinuing certain features of the Service), temporarily or
          permanently, without notice to you. Prompt Later will have no liability for any change
          to the Service.
        </p>
        ...
        <p>
          ...
          notice to https://github.com/brahimhamichan/prompt-later/issues. We may delete or disable content that we believe violates
        ...
        <h2>12. Privacy</h2>
        <p>
          Please read the Prompt Later Privacy Policy carefully for information relating to our
        ...
        <p>
          ...
          and you will defend and indemnify Prompt Later, its affiliates and each of their
        ...
        <p className="!uppercase !font-semibold">
          ...
          available&rdquo; basis. Prompt Later disclaims all warranties of any kind, whether
          ...
          Prompt Later does not warrant that the Service or Suggestions will be uninterrupted,
          secure, or free of errors, viruses, or other harmful components.
        </p>

        <h2>15. Limitation of Liability</h2>
        <p className="!uppercase !font-semibold">
          To the fullest extent permitted by law, in no event will the Prompt Later entities be
          liable for any indirect, incidental, special, consequential or punitive damages arising
          out of or relating to these Terms, the Service, or Content. The aggregate liability of the
          Prompt Later entities to you for all claims is limited to the greater of: (a) the
          amount you have paid to Prompt Later for access to and use of the Service in the six
        ...
        <p>
          ...
          and Prompt Later will be resolved exclusively through final and binding arbitration,
          ...
          and Prompt Later are each waiving the right to a trial by jury or to participate in a
        ...
        <p>
          ...
          https://github.com/brahimhamichan/prompt-later/issues from the email address used to create your account.
        </p>
        ...
        <p>
          ...
          between you and Prompt Later regarding your use of the Service. California law will
          govern these Terms except for its conflicts of laws principles.
        </p>
        <p>You may contact us by emailing us at https://github.com/brahimhamichan/prompt-later/issues.</p>
